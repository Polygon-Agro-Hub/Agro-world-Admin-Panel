...
export class FixedAssetCategoryComponent {
  ...
  buildingCategory(id: number) {
    this.router.navigate(['admin/plant-care/action/assets/fixed-asset-category/building-fixed-asset'], { 
      queryParams: { id, category: 'Building and Infrastructures' , fullName: this.fullName} 
    });
  }

  landCategory(id: number) {
    this.router.navigate(['admin/plant-care/action/assets/fixed-asset-category/land-fixed-asset'], { 
      queryParams: { id, category: 'Land', fullName: this.fullName } 
    });
  }

  machCategory(id: number) {
    this.router.navigate(['admin/plant-care/action/assets/fixed-asset-category/machinary&tools-fixed-asset'], { 
