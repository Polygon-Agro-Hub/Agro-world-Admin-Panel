...
export class AssignCitiesComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    const provinceNames = [
      ...new Set(this.districts.map((district) => district.province)),
    ];
    provinceNames.sort();
  ...
  fetchData() {
    ...
    this.distributionHubSrv
      .getAssignForCityes(provinceName, districtName)
      .subscribe(
        (res) => {
  ...
  saveAssignment(cityId: number, centerId: number): void {
    ...
    this.distributionHubSrv
      .AssigCityToDistributedCenter(assignmentToSave)
      .subscribe(
        (res) => {
          this.isLoading = false;
          Swal.fire({
  ...
  removeAssignment(cityId: number, centerId: number): void {
    ...
    this.distributionHubSrv
      .removeAssigCityToDistributedCenter(assignmentToRemove)
      .subscribe(
        (res) => {
          this.isLoading = false;
          Swal.fire({
