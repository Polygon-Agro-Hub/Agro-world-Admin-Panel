...
export class DistributionHubService {
  ...
  createDistributionHead(person: any, selectedImage: any): Observable<any> {
    ...
    return this.http
      .post(`${this.apiUrl}distribution/create-distribution-head`, formData, {
        headers,
      })
      .pipe(
  ...
  AssigCityToDistributedCenter(data: any): Observable<any> {
    ...
    return this.http.post(
      `${this.apiUrl}distribution/assign-city-to-distributed-center`,
      data,
      {
        headers,
      }
  ...
  removeAssigCityToDistributedCenter(data: any): Observable<any> {
    ...
    return this.http.post(
      `${this.apiUrl}distribution/remove-assign-city-to-distributed-center`,
      data,
      {
        headers,
      }
  ...
  claimDistributedOfficer(data: any): Observable<any> {
    ...
    return this.http.patch(
      `${this.apiUrl}distribution/claim-distributed-Officer`,
      data,
      {
        headers,
      }
  ...
  getDistributedDriversAndVehicles(
    distributedCompanyCenterId: number,
    page: number = 1,
    limit: number = 10,
    status?: string,
    vehicleType?: string,
    ...
    if (vehicleType && vehicleType.trim()) {
      params = params.set('vehicleType', vehicleType.trim());
    }
