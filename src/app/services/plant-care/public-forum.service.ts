...
export class PublicForumService {
  ...
  sendMessage(
    ...
    return this.http.post(
      `${this.apiUrl}auth/send-message/${chatId}`,
      replyData,
      {
        headers,
      },
  ...
  getAllPostReply(postId: number): Observable<any> {
    ...
    return this.http.get(`${this.apiUrl}auth/get-all-reply/${postId}`, {
      headers,
    });
  }
  ...
  deleteReply(repId: number) {
    ...
    return this.http.delete(`${this.apiUrl}auth/delete-reply/${repId}`, {
      headers,
    });
  }
  ...
  deletePublicForumPost(postId: number) {
    ...
    return this.http.delete(`${this.apiUrl}auth/delete-post/${postId}`, {
      headers,
    });
  }
