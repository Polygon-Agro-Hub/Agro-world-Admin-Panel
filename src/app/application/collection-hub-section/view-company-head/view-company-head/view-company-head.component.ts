...
export class ViewCompanyHeadComponent implements OnInit {
  ...
  const tableHtml = `
    <div class="px-10 py-8 rounded-md bg-white dark:bg-gray-800">
      ...
      <div>
        ${showRejectButton ? '<p class="text-center dark:text-white">Are you sure you want to reject this collection Centre Head ?</p>' : ''}
        ${showApproveButton ? '<p class="text-center dark:text-white">Are you sure you want to approve this collection Centre Head ?</p>' : ''}
      </div>
