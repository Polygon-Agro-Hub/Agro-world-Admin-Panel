...
export class CreateMarketPriceComponent {
  ...
  getMarketPrice(id: any) {
    ...
    this.http
      .get<
        NewsItem[]
      >(`${environment.API_URL}auth/get-market-price-by-id/${id}`, { headers })
      .subscribe(
        (data) => {
          this.newsItems = data;
  ...
  createMarketPrice() {
    ...
    formData.append(
      "titleEnglish",
      this.isEnglishOnly(this.createMarketObj.titleEnglish),
    );
    formData.append(
      "titleSinhala",
      this.isSinhalaAndNumberOnly(this.createMarketObj.titleSinhala),
    );
    formData.append(
      "titleTamil",
      this.isTamilAndNumberOnly(this.createMarketObj.titleTamil),
    );
    ...
    if (
      ...
      this.http
        .post(
          `${environment.API_URL}auth/admin-create-market-price`,
          formData,
          { headers },
        )
        .subscribe(
  ...
  updateMarketPrice() {
    ...
    this.http
      .put(
        `${environment.API_URL}auth/edit-market-price/${this.itemId}`,
        formData,
        { headers },
      )
      .subscribe(
