    ...
    this.stakeholderSrv.getCollectionOfficerData().subscribe(
      (res) => {
        ...
        this.centerHeadOfficers =
          res.collectionOfficersByPosition[0]?.officerCount ?? 0;
        this.centerManagers =
          res.collectionOfficersByPosition[1]?.officerCount ?? 0;
        this.collectionOfficers =
          res.collectionOfficersByPosition[2]?.officerCount ?? 0;
        this.customerOfficers =
          res.collectionOfficersByPosition[3]?.officerCount ?? 0;
        ...
        this.activeOfficers =
          res.activeCollectionOfficers[0]?.activeOfficerCount ?? 0;
      },
      (error) => {
